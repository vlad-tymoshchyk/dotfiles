...
alias grepi="grep -i"
alias grepr="grep -R -n --exclude-dir=dist --exclude-dir=node_modules --exclude-dir=coverage --exclude-dir=build --exclude-dir=lib --exclude=package-lock.json"
alias grepri="grepr -i"
